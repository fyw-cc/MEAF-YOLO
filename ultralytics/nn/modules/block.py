...
class RFEM(nn.Module):
    def __init__(self, c, se_ratio=4):
        super().__init__()
        self.incep = IncepConv(c)
        self.lka = LKA(c)
        self.wave = WaveBlock(c, se_ratio=se_ratio)
